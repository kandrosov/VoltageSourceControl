...
public:
     ...
     * \throw vsc::exception if no working mode was found.
    ...
    ValueType GetValue(ModeType mode) const {
        ...
        const DimensionlessValueType value = static_cast<DimensionlessValueType>(valueIter->second);
...
private:
    ...
    void ReportError(const std::string& message) const {
        ...
        for(typename ValueRangeMap::left_const_iterator iter = ranges.left.begin(); iter != ranges.left.end();
                ++iter) {
            const DimensionlessValueType value = static_cast<DimensionlessValueType>(iter->second);
 ...
 * \return input stream
 */
std::istream& operator >>(std::istream& s, vsc::Keithley237Internals::Measurement& m);
 ...
 * \return input stream
 */
std::istream& operator >>(std::istream& s, vsc::Keithley237Internals::ComplianceValue& c);
 ...
 * \return input stream
 */
std::istream& operator >>(std::istream& s, vsc::Keithley237Internals::ErrorStatus& e);
 ...
 * \return input stream
 */
std::istream& operator >>(std::istream& s, vsc::Keithley237Internals::WarningStatus& w);
 ...
 * \return input stream
 */
std::istream& operator >>(std::istream& s, vsc::Keithley237Internals::MachineStatus& m);
