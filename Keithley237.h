...
private:
     ...
     * \throw vsc::exception if some errors occured while sending a command.
     ...
     * \throw vsc::exception if some errors occured while sending a command or if after the command execution Keithley
...
public:
    /*!
     * \brief Constructor
     * \throw vsc::exception when there is no fiter mode or integraation time mode found for the given parameters.
