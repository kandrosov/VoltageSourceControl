/*!
 * \file log.h
 * \brief Definition of VSC Logging System.
 *
 ...
 *   LogError   print messages on screen via vsc::LogError(), dump into output
 ...
 *
 *   vsc::LogInfo().open( "info.log"); // set output filename: works only once
 *
 *   vsc::LogInfo() << "This is a message into Info Log" << std::endl;
 *
 *   vsc::LogInfo() << "Analog of previous line: not head is output" << std::endl;
 *
 *   vsc::LogInfo( "Head" ) << "This is a message with head" << std::endl;
 *
 *   vsc::LogInfo( __func__) << "Message from some function" << std::endl;
 *
 *   vsc::LogInfo( __PRETTY_FUNCTION__ ) << "Message from some function" << std::endl;
 *
 *   vsc::LogInfo( "Test1") << "Voltage: " << _voltage << std::endl;
 */
